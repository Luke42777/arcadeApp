...
public:
	...
	inline bool operator==(const Color& col)const { return mColor == col.mColor; }
	inline bool operator!=(const Color& col)const { return !(*this == col); }
